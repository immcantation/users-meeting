...
### Pre-Existing Memory B Cell Phenotype Determines the Quality of B Cell Response to Vaccine Boosters {#session4}

<strong>Noemia S. Lima</strong><sup>1</sup>, Abby Spangler<sup>1</sup>, Lauren McCormick<sup>1</sup>, Samuel Li<sup>1</sup>, Christian G. Wake<sup>1</sup>, Yoav Pinto<sup>1</sup>, William Catalano<sup>1</sup>, Sarah Andrews<sup>1</sup>, Chaim A. Schramm<sup>1\*</sup>, Daniel C. Douek<sup>1\*</sup> 
...
Different COVID-19 vaccine modalities expressing the same SARS-CoV-2 spike antigen present a unique opportunity to contrast the immunologic outcomes associated with each vaccine platform. Here we characterized the memory B cell response elicited by initial vaccination with either the Janssen adenovirus-vectored vaccine Ad26.COV2.S or the Moderna mRNA-1273 vaccine and then boosted 3-6 months later with Moderna mRNA-1273. Using lineage tracking by single-cell IG sequencing in concert with single-cell RNA sequencing and cellular indexing of transcriptomes and epitopes by sequencing (CITE-Seq), we characterized B cell lineages exhibiting different phenotypes at each time point. We showed that the dynamics of this process depended on the priming vaccine type and used Dowser to reveal likely pathways between distinct cell states. We identified B cell lineages with significant clonal evolution over 6 months post-boost and showed the clonal relationship between different cell phenotypes. We also found notable differences in the isotype distribution and levels of affinity maturation between the two priming modalities. Overall, our findings suggest that the type of response elicited by boosting is dependent on the nature of pre-existing memory B cells imprinted by the vaccine priming. 
